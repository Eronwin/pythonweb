...
class StringVector(object):
    ...
    def __init__(self, *args):
        _example.StringVector_swiginit(self, _example.new_StringVector(*args))
...
# Register StringVector in _example:
_example.StringVector_swigregister(StringVector)
...
def vector_int2str(input):
    return _example.vector_int2str(input)

def match(origin, pattern):
    return _example.match(origin, pattern)
